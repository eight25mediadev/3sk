...
INSERT INTO `com_vtiger_workflows` (`workflow_id`, `module_name`, `summary`, `test`, `execution_condition`, `defaultworkflow`, `type`, `filtersavedinnew`) VALUES
(1, 'Invoice', 'UpdateInventoryProducts On Every Save', '[{"fieldname":"subject","operation":"does not contain","value":"`!`"}]', 3, 1, 'basic', 5),
(2, 'Accounts', 'Send Email to user when Notifyowner is True', '[{"fieldname":"notify_owner","operation":"is","value":"true:boolean"}]', 2, 1, 'basic', 5),
(3, 'Contacts', 'Send Email to user when Notifyowner is True', '[{"fieldname":"notify_owner","operation":"is","value":"true:boolean"}]', 2, 1, 'basic', 5),
(4, 'Contacts', 'Send Email to user when Portal User is True', '[{"fieldname":"portal","operation":"is","value":"true:boolean"}]', 2, 1, 'basic', 5),
(5, 'Potentials', 'Send Email to users on Potential creation', NULL, 1, 1, 'basic', 5),
(6, 'Contacts', 'Workflow for Contact Creation or Modification', '', 3, 1, 'basic', 5),
(7, 'HelpDesk', 'Ticket Creation From Portal : Send Email to Record Owner and Contact', '[{"fieldname":"from_portal","operation":"is","value":1,"valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":0},{"fieldname":"from_portal","operation":"is","value":"1","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"}]', 1, 1, 'basic', 6),
(9, 'HelpDesk', 'Send Email to Contact on Ticket Update', '[{"fieldname":"(contact_id : (Contacts) emailoptout)","operation":"is","value":"0","valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":"0"},{"fieldname":"from_portal","operation":"is","value":0,"valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":0},{"fieldname":"ticketstatus","operation":"has changed to","value":"Closed","valuetype":"rawtext","joincondition":"or","groupjoin":"and","groupid":"1"},{"fieldname":"solution","operation":"has changed","value":"","valuetype":"","joincondition":"or","groupjoin":"and","groupid":"1"},{"fieldname":"description","operation":"has changed","value":"","valuetype":"","joincondition":"or","groupjoin":"and","groupid":"1"}]', 3, 1, 'basic', 6),
(10, 'Events', 'Workflow for Events when Send Notification is True', '[{"fieldname":"sendnotification","operation":"is","value":"true:boolean"}]', 3, 1, 'basic', 5),
(11, 'Calendar', 'Workflow for Calendar Todos when Send Notification is True', '[{"fieldname":"sendnotification","operation":"is","value":"true:boolean"}]', 3, 1, 'basic', 5),
(12, 'Potentials', 'Calculate or Update forecast amount', '', 3, 1, 'basic', 5),
(13, 'Events', 'Workflow for Events when Send Notification is True', '[{"fieldname":"sendnotification","operation":"is","value":"true:boolean"}]', 3, 1, 'basic', 5),
(14, 'Calendar', 'Workflow for Calendar Todos when Send Notification is True', '[{"fieldname":"sendnotification","operation":"is","value":"true:boolean"}]', 3, 1, 'basic', 5),
(15, 'HelpDesk', 'Comment Added From CRM : Send Email to Organization', '[{"fieldname":"_VT_add_comment","operation":"is added","value":"","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"},{"fieldname":"from_portal","operation":"is","value":"0","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"},{"fieldname":"(parent_id : (Accounts) emailoptout)","operation":"is","value":"0","valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":"0"}]', 3, 1, 'basic', 6),
(16, 'PurchaseOrder', 'Update Inventory Products On Every Save', NULL, 3, 1, 'basic', 5),
(17, 'HelpDesk', 'Comment Added From Portal : Send Email to Record Owner', '[{"fieldname":"_VT_add_comment","operation":"is added","value":"","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"},{"fieldname":"from_portal","operation":"is","value":"1","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"}]', 3, 1, 'basic', 6),
(18, 'HelpDesk', 'Comment Added From CRM : Send Email to Contact, where Contact is not a Portal User', '[{"fieldname":"(contact_id : (Contacts) portal)","operation":"is","value":"0","valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":"0"},{"fieldname":"_VT_add_comment","operation":"is added","value":"","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"},{"fieldname":"from_portal","operation":"is","value":"0","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"},{"fieldname":"(contact_id : (Contacts) emailoptout)","operation":"is","value":"0","valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":"0"}]', 3, 1, 'basic', 6),
...
(21, 'HelpDesk', 'Ticket Creation From CRM : Send Email to Record Owner', '[{"fieldname":"from_portal","operation":"is","value":"0","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"}]', 1, 1, 'basic', 6),
...
(23, 'HelpDesk', 'Ticket Creation From CRM : Send Email to Organization', '[{"fieldname":"(parent_id : (Accounts) emailoptout)","operation":"is","value":"0","valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":"0"},{"fieldname":"from_portal","operation":"is","value":"0","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"}]', 1, 1, 'basic', 6),
(24, 'HelpDesk', 'Ticket Creation From CRM : Send Email to Contact', '[{"fieldname":"(contact_id : (Contacts) emailoptout)","operation":"is","value":"0","valuetype":"rawtext","joincondition":"and","groupjoin":"and","groupid":"0"},{"fieldname":"from_portal","operation":"is","value":"0","valuetype":"rawtext","joincondition":"","groupjoin":"and","groupid":"0"}]', 1, 1, 'basic', 6);
...
(14, 13, 'Send Notification Email to Record Owner', 'O:11:"VTEmailTask":8:{s:18:"executeImmediately";s:0:"";s:10:"workflowId";s:2:"13";s:7:"summary";s:39:"Send Notification Email to Record Owner";s:6:"active";s:1:"1";s:9:"recepient";s:36:"$(assigned_user_id : (Users) email1)";s:7:"subject";s:17:"Event :  $subject";s:7:"content";s:681:"$(assigned_user_id : (Users) last_name) $(assigned_user_id : (Users) first_name) ,<br/><b>Activity Notification Details:</b><br/>Subject             : $subject<br/>Start date and time : $date_start<br/>End date and time   : $due_date <br/>Status              : $eventstatus <br/>Priority            : $taskpriority <br/>Related To          : $(parent_id : (Leads) lastname) $(parent_id : (Leads) firstname) $(parent_id : (Accounts) accountname) $(parent_id : (Potentials) potentialname) $(parent_id : (HelpDesk) ticket_title) $(parent_id : (Campaigns) campaignname) <br/>Contacts List       : $contact_id <br/>Location            : $location <br/>Description         : $description";s:2:"id";s:2:"14";}'),
(15, 14, 'Send Notification Email to Record Owner', 'O:11:"VTEmailTask":8:{s:18:"executeImmediately";s:0:"";s:10:"workflowId";s:2:"14";s:7:"summary";s:39:"Send Notification Email to Record Owner";s:6:"active";s:1:"1";s:9:"recepient";s:36:"$(assigned_user_id : (Users) email1)";s:7:"subject";s:16:"Task :  $subject";s:7:"content";s:627:"$(assigned_user_id : (Users) last_name) $(assigned_user_id : (Users) first_name) ,<br/><b>Task Notification Details:</b><br/>Subject : $subject<br/>Start date and time : $date_start<br/>End date and time   : $due_date <br/>Status              : $taskstatus <br/>Priority            : $taskpriority <br/>Related To          : $(parent_id : (Leads) lastname) $(parent_id : (Leads) firstname) $(parent_id : (Accounts) accountname) $(parent_id : (Potentials) potentialname) $(parent_id : (HelpDesk) ticket_title) $(parent_id : (Campaigns) campaignname) <br/>Contacts List       : $contact_id <br/>Description         : $description";s:2:"id";s:2:"15";}'),
...
(4, '12x5', 0, '{"fromEmail":"dev@eight25media.com","fromName":"admin","toEmail":"dev@eight25media.com","ccEmail":"","bccEmail":"","subject":"Regarding Contact Assignment","content":"An Contact has been assigned to you on vtigerCRM<br>Details of Contact are :<br><br>Contact Id:<b>CON1<\\/b><br>LastName:<b>Sivanoly<\\/b><br>FirstName:<b>Nesaratnam<\\/b><br>Lead Source:<b><\\/b><br>Department:<b><\\/b><br>Description:<b><\\/b><br><br><br>And <b>CustomerPortal Login Details<\\/b> is sent to the EmailID :-sivanoly@eight25media.com<br><br>Thank You<br>Admin"}'),
(19, '17x6', 0, '{"fromEmail":"sivanoly@eight25media.com","fromName":"Sivanoly Nesaratnam","toEmail":",dev@eight25media.com","ccEmail":"","bccEmail":"","subject":"Respond to Ticket ID## 6 ## in Customer Portal - URGENT","content":"Dear Administrator ,<br><br>\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tCustomer has provided the following additional information to your reply:<br><br>\\r\\n\\t\\t\\t\\t\\t\\t\\t\\t<b><br><br>hhh<\\/b><br><br>\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tKindly respond to above ticket at the earliest.<br><br>\\r\\n\\t\\t\\t\\t\\t\\t\\t\\tRegards<br>Support Administrator"}');
...
INSERT INTO `com_vtiger_workflow_activatedonce` (`workflow_id`, `entity_id`) VALUES
(4, 5);
...
(5, 'CON1', 0, 'Mr.', 'Nesaratnam', 'Sivanoly', 'sivanoly@eight25media.com', '776341201', '776341201', '', '', '776341201', '0', NULL, NULL, NULL, NULL, '', '0', '0', '', '0', '0', NULL);
...
(5, '776341201', '776341201', '', '776341201', NULL, 0, 0, '');
...
(2, 1, 1, 1, 'HelpDesk', '', '2018-01-30 15:59:27', '2018-01-30 15:59:27', NULL, NULL, 0, 1, 0, 'Tst 1'),
(3, 1, 1, 1, 'HelpDesk', '', '2018-01-30 16:01:14', '2018-01-30 16:01:14', NULL, NULL, 0, 1, 0, 'Tst 1'),
(4, 1, 1, 1, 'HelpDesk', '', '2018-01-30 16:01:55', '2018-01-30 16:01:55', NULL, NULL, 0, 1, 0, 'Tst 1'),
(5, 1, 1, 1, 'Contacts', '', '2018-01-30 16:36:13', '2018-01-30 16:36:13', NULL, NULL, 0, 1, 0, 'Nesaratnam Sivanoly'),
(6, 1, 1, 1, 'HelpDesk', ' Example: INSERT INTO tbl_name (col_A,col_B,col_C) VALUES (1,2,3)', '2018-01-30 17:38:32', '2018-01-30 17:38:32', NULL, NULL, 0, 1, 0, 'Test 1'),
(7, 1, 1, 1, 'ModComments', NULL, '2018-01-30 17:53:55', '2018-01-30 17:53:55', NULL, NULL, 0, 1, 0, 'hhh'),
(8, 1, 1, 1, 'HelpDesk', 'test issue', '2018-03-21 09:48:23', '2018-03-21 09:48:23', NULL, NULL, 0, 1, 0, 'test issue');
...
(7, 'Scheduled Import', 'cron/modules/Import/ScheduledImport.service', 900, NULL, NULL, 1, 'Import', 6, 'Recommended frequency for MailScanner is 15 mins');
...
(42, 'All', 1, 0, 'ProjectMilestone', 0, 1),
(43, 'All', 1, 0, 'ProjectTask', 0, 1),
(44, 'All', 1, 0, 'Project', 0, 1),
...
(41, 2, 'vtiger_crmentity:modifiedtime:modifiedtime:ModComments_Modified_Time:T'),
(41, 3, 'vtiger_crmentity:smownerid:assigned_user_id:ModComments_Assigned_To:V'),
(42, 0, 'vtiger_projectmilestone:projectmilestonename:projectmilestonename:ProjectMilestone_Project_Milestone_Name:V'),
(42, 1, 'vtiger_projectmilestone:projectmilestonedate:projectmilestonedate:ProjectMilestone_Milestone_Date:D'),
(42, 3, 'vtiger_crmentity:description:description:ProjectMilestone_description:V'),
(42, 4, 'vtiger_crmentity:createdtime:createdtime:ProjectMilestone_Created_Time:T'),
(42, 5, 'vtiger_crmentity:modifiedtime:modifiedtime:ProjectMilestone_Modified_Time:T'),
(43, 2, 'vtiger_projecttask:projecttaskname:projecttaskname:ProjectTask_Project_Task_Name:V'),
(43, 3, 'vtiger_projecttask:projectid:projectid:ProjectTask_Related_to:V'),
(43, 4, 'vtiger_projecttask:projecttaskpriority:projecttaskpriority:ProjectTask_Priority:V'),
(43, 5, 'vtiger_projecttask:projecttaskprogress:projecttaskprogress:ProjectTask_Progress:V'),
(43, 6, 'vtiger_projecttask:projecttaskhours:projecttaskhours:ProjectTask_Worked_Hours:V'),
(43, 7, 'vtiger_projecttask:startdate:startdate:ProjectTask_Start_Date:D'),
(43, 8, 'vtiger_projecttask:enddate:enddate:ProjectTask_End_Date:D'),
(43, 9, 'vtiger_crmentity:smownerid:assigned_user_id:ProjectTask_Assigned_To:V'),
(44, 0, 'vtiger_project:projectname:projectname:Project_Project_Name:V'),
(44, 1, 'vtiger_project:linktoaccountscontacts:linktoaccountscontacts:Project_Related_to:V'),
(44, 2, 'vtiger_project:startdate:startdate:Project_Start_Date:D'),
(44, 3, 'vtiger_project:targetenddate:targetenddate:Project_Target_End_Date:D'),
(44, 4, 'vtiger_project:actualenddate:actualenddate:Project_Actual_End_Date:D'),
(44, 5, 'vtiger_project:targetbudget:targetbudget:Project_Target_Budget:V'),
(44, 6, 'vtiger_project:progress:progress:Project_Progress:V'),
(44, 7, 'vtiger_project:projectstatus:projectstatus:Project_Status:V'),
(44, 8, 'vtiger_crmentity:smownerid:assigned_user_id:Project_Assigned_To:V'),
...
(45, 3, 'vtiger_crmentity:createdtime:createdtime:SMSNotifier_Created_Time:T'),
(45, 4, 'vtiger_crmentity:modifiedtime:modifiedtime:SMSNotifier_Modified_Time:T');
...
(10, 'vtiger.entity.beforesave', 'modules/ServiceContracts/ServiceContractsHandler.php', 'ServiceContractsHandler', '', 0, '[]'),
(11, 'vtiger.entity.aftersave', 'modules/ServiceContracts/ServiceContractsHandler.php', 'ServiceContractsHandler', '', 0, '[]'),
...
(14, 'vtiger.entity.aftersave', 'modules/ModComments/ModCommentsHandler.php', 'ModCommentsHandler', '', 1, '[]'),
(15, 'vtiger.picklist.afterrename', 'modules/Settings/Picklist/handlers/PickListHandler.php', 'PickListHandler', '', 1, '[]'),
(16, 'vtiger.picklist.afterdelete', 'modules/Settings/Picklist/handlers/PickListHandler.php', 'PickListHandler', '', 1, '[]');
...
(13, 164, 'hours', 'vtiger_troubletickets', 1, '1', 'hours', 'Hours', 1, 2, '', 100, 10, 25, 1, 'I~O', 1, NULL, 'BAS', 1, 'This gives the estimated hours for the Ticket.<br>When the same ticket is added to a Service Contract,based on the Tracking Unit of the Service Contract,Used units is updated whenever a ticket is Closed.', 0),
(13, 165, 'days', 'vtiger_troubletickets', 1, '1', 'days', 'Days', 1, 2, '', 100, 11, 25, 1, 'I~O', 1, NULL, 'BAS', 1, 'This gives the estimated days for the Ticket.<br>When the same ticket is added to a Service Contract,based on the Tracking Unit of the Service Contract,Used units is updated whenever a ticket is Closed.', 0),
...
(8, 204, 'title', 'vtiger_notes', 1, '2', 'notes_title', 'Title', 1, 0, '', 100, 1, 17, 1, 'V~M', 0, 1, 'BAS', 0, NULL, 1),
...
(8, 208, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 0, '', 100, 4, 17, 1, 'V~M', 0, 3, 'BAS', 0, NULL, 1),
(8, 209, 'notecontent', 'vtiger_notes', 1, '19', 'notecontent', 'Note', 1, 2, '', 100, 1, 84, 1, 'V~O', 1, NULL, 'BAS', 0, NULL, 0),
...
(8, 213, 'fileversion', 'vtiger_notes', 1, '1', 'fileversion', 'Version', 1, 2, '', 100, 6, 18, 1, 'V~O', 1, 0, 'BAS', 0, NULL, 0),
(8, 214, 'filestatus', 'vtiger_notes', 1, '56', 'filestatus', 'Active', 1, 2, '1', 100, 2, 18, 1, 'V~O', 1, 0, 'BAS', 0, NULL, 0),
(8, 215, 'filedownloadcount', 'vtiger_notes', 1, '1', 'filedownloadcount', 'Download Count', 1, 2, '', 100, 7, 18, 2, 'I~O', 3, 0, 'BAS', 0, NULL, 0),
(8, 216, 'folderid', 'vtiger_notes', 1, '26', 'folderid', 'Folder Name', 1, 2, '', 100, 2, 17, 1, 'V~O', 2, 2, 'BAS', 0, NULL, 1),
...
(19, 307, 'active', 'vtiger_pricebook', 1, '56', 'active', 'Active', 1, 2, '', 100, 2, 46, 1, 'C~O', 2, 2, 'BAS', 1, NULL, 1),
...
(23, 450, 's_h_amount', 'vtiger_invoice', 1, '72', 'hdnS_H_Amount', 'S&H Amount', 1, 2, '', 100, 14, 69, 3, 'N~O', 3, NULL, 'BAS', 1, NULL, 0),
...
(29, 475, 'is_admin', 'vtiger_users', 1, '156', 'is_admin', 'Admin', 1, 0, '', 3, 2, 77, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 476, 'user_password', 'vtiger_users', 1, '99', 'user_password', 'Password', 1, 0, '', 30, 3, 77, 4, 'P~M', 1, NULL, 'BAS', 1, NULL, 0),
(29, 477, 'confirm_password', 'vtiger_users', 1, '99', 'confirm_password', 'Confirm Password', 1, 0, '', 30, 5, 77, 4, 'P~M', 1, NULL, 'BAS', 1, NULL, 0),
(29, 478, 'first_name', 'vtiger_users', 1, '1', 'first_name', 'First Name', 1, 0, '', 30, 7, 77, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 479, 'last_name', 'vtiger_users', 1, '2', 'last_name', 'Last Name', 1, 0, '', 30, 9, 77, 1, 'V~M', 1, NULL, 'BAS', 1, NULL, 0),
(29, 480, 'roleid', 'vtiger_user2role', 1, '98', 'roleid', 'Role', 1, 0, '', 200, 11, 77, 1, 'V~M', 1, NULL, 'BAS', 1, NULL, 0),
(29, 481, 'email1', 'vtiger_users', 1, '104', 'email1', 'Email', 1, 0, '', 100, 4, 77, 1, 'E~M', 1, NULL, 'BAS', 1, NULL, 0),
(29, 482, 'status', 'vtiger_users', 1, '115', 'status', 'Status', 1, 0, 'Active', 100, 6, 77, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 483, 'activity_view', 'vtiger_users', 1, '16', 'activity_view', 'Default Activity View', 1, 0, '', 100, 12, 117, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 484, 'lead_view', 'vtiger_users', 1, '16', 'lead_view', 'Default Lead View', 1, 0, '', 100, 10, 77, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 485, 'hour_format', 'vtiger_users', 1, '16', 'hour_format', 'Calendar Hour Format', 1, 0, '12', 100, 13, 117, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 486, 'end_hour', 'vtiger_users', 1, '116', 'end_hour', 'Day ends at', 1, 0, '', 100, 15, 77, 3, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
(29, 487, 'start_hour', 'vtiger_users', 1, '16', 'start_hour', 'Day starts at', 1, 0, '', 100, 14, 117, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
...
(29, 498, 'date_format', 'vtiger_users', 1, '16', 'date_format', 'Date Format', 1, 0, '', 30, 12, 117, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
...
(29, 507, 'time_zone', 'vtiger_users', 1, '16', 'time_zone', 'Time Zone', 1, 0, '', 200, 15, 117, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
...
(29, 517, 'reminder_interval', 'vtiger_users', 1, '16', 'reminder_interval', 'Reminder Interval', 1, 0, '', 100, 1, 117, 1, 'V~O', 1, NULL, 'BAS', 1, NULL, 0),
...
(34, 525, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 17, 88, 2, 'V~O', 3, 0, 'BAS', 0, '', 0),
(34, 526, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 18, 88, 2, 'V~O', 3, 0, 'BAS', 0, '', 0),
...
(35, 551, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 13, 90, 2, 'T~O', 3, 0, 'BAS', 0, '', 0),
(35, 552, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 14, 90, 2, 'T~O', 3, 0, 'BAS', 0, '', 0),
...
(35, 558, 'unit_price', 'vtiger_service', 1, '72', 'unit_price', 'Price', 1, 2, '', 100, 1, 91, 1, 'N~O', 2, 2, 'BAS', 0, '', 1),
...
(37, 576, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 14, 94, 2, 'T~O', 3, 0, 'BAS', 0, '\n                    ', 0),
(37, 577, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 15, 94, 2, 'T~O', 3, 0, 'BAS', 0, '\n                    ', 0),
...
(41, 582, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 98, 2, 'T~O', 0, 2, 'BAS', 0, '', 0),
(41, 583, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 98, 2, 'T~O', 0, 3, 'BAS', 0, '', 0),
...
(46, 630, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 109, 2, 'T~O', 1, NULL, 'BAS', 0, '', 0),
(46, 631, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 109, 2, 'T~O', 1, NULL, 'BAS', 0, '', 0),
(46, 632, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 109, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(46, 633, 'message', 'vtiger_smsnotifier', 1, '21', 'message', 'message', 1, 0, '', 100, 1, 109, 1, 'V~M', 1, NULL, 'BAS', 1, '', 1),
...
(29, 675, 'dayoftheweek', 'vtiger_users', 1, '16', 'dayoftheweek', 'Starting Day of the week', 1, 2, 'Monday', 100, 2, 117, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(29, 676, 'callduration', 'vtiger_users', 1, '16', 'callduration', 'Default Call Duration', 1, 2, '5', 100, 3, 117, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(29, 677, 'othereventduration', 'vtiger_users', 1, '16', 'othereventduration', 'Other Event Duration', 1, 2, '5', 100, 4, 117, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(29, 682, 'calendarsharedtype', 'vtiger_users', 1, '16', 'calendarsharedtype', 'Calendar Shared Type', 1, 2, 'Public', 100, 2, 117, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(1, 'English', 'en_us', 'US English', '2018-01-30 15:38:56', NULL, 1, 1),
(2, 'Brazilian', 'pt_br', 'PT Brasil', '2018-01-30 15:49:32', NULL, 0, 1),
(3, 'BritishEnglish', 'en_gb', 'British English', '2018-01-30 15:49:33', NULL, 0, 1),
(4, 'Deutsch', 'de_de', 'DE Deutsch', '2018-01-30 15:49:33', NULL, 0, 1),
(5, 'Dutch', 'nl_nl', 'NL-Dutch', '2018-01-30 15:49:33', NULL, 0, 1),
(6, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2018-01-30 15:49:33', NULL, 0, 1),
(7, 'Hungarian', 'hu_hu', 'HU Magyar', '2018-01-30 15:49:34', NULL, 0, 1),
(8, 'Italian', 'it_it', 'IT Italian', '2018-01-30 15:49:35', NULL, 0, 1),
(9, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2018-01-30 15:49:34', NULL, 0, 1),
(10, 'Język Polski', 'pl_pl', 'Język Polski', '2018-01-30 15:49:36', NULL, 0, 1),
(11, 'Romana', 'ro_ro', 'Romana', '2018-01-30 15:49:35', NULL, 0, 1),
(12, 'Russian', 'ru_ru', 'Russian', '2018-01-30 15:49:36', NULL, 0, 1),
(13, 'Spanish', 'es_es', 'ES Spanish', '2018-01-30 15:49:34', NULL, 0, 1),
(14, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2018-01-30 15:49:35', NULL, 0, 1);
...
(28, 41, 'HEADERSCRIPT', 'ModCommentsCommonHeaderScript', 'modules/ModComments/ModCommentsCommon.js', '', 0, NULL, NULL, NULL),
(29, 43, 'DETAILVIEWBASIC', 'Add Note', 'index.php?module=Documents&action=EditView&return_module=ProjectTask&return_action=DetailView&return_id=$RECORD$&parent_id=$RECORD$', '', 0, 'modules/Documents/Documents.php', 'Documents', 'isLinkPermitted'),
(30, 43, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(31, 44, 'DETAILVIEWBASIC', 'Add Project Task', 'index.php?module=ProjectTask&action=EditView&projectid=$RECORD$&return_module=Project&return_action=DetailView&return_id=$RECORD$', '', 0, 'modules/ProjectTask/ProjectTask.php', 'ProjectTask', 'isLinkPermitted'),
(32, 44, 'DETAILVIEWBASIC', 'Add Note', 'index.php?module=Documents&action=EditView&return_module=Project&return_action=DetailView&return_id=$RECORD$&parent_id=$RECORD$', '', 1, 'modules/Documents/Documents.php', 'Documents', 'isLinkPermitted'),
(33, 44, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(34, 46, 'DETAILVIEWBASIC', 'LBL_CHECK_STATUS', 'javascript:SMSNotifier.checkstatus($RECORD$)', 'themes/images/reload.gif', 0, NULL, NULL, NULL),
(36, 2, 'DASHBOARDWIDGET', 'History', 'index.php?module=Potentials&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(37, 2, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Potentials&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(38, 2, 'DASHBOARDWIDGET', 'Funnel', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesStage', '', 3, NULL, NULL, NULL),
(39, 2, 'DASHBOARDWIDGET', 'Potentials by Stage', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesPerson', '', 4, NULL, NULL, NULL),
(40, 2, 'DASHBOARDWIDGET', 'Pipelined Amount', 'index.php?module=Potentials&view=ShowWidget&name=PipelinedAmountPerSalesPerson', '', 5, NULL, NULL, NULL),
(41, 2, 'DASHBOARDWIDGET', 'Total Revenue', 'index.php?module=Potentials&view=ShowWidget&name=TotalRevenuePerSalesPerson', '', 6, NULL, NULL, NULL),
(42, 2, 'DASHBOARDWIDGET', 'Top Potentials', 'index.php?module=Potentials&view=ShowWidget&name=TopPotentials', '', 7, NULL, NULL, NULL),
(43, 2, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Potentials&view=ShowWidget&name=OverdueActivities', '', 9, NULL, NULL, NULL),
(44, 6, 'DASHBOARDWIDGET', 'History', 'index.php?module=Accounts&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(45, 6, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Accounts&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(46, 6, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Accounts&view=ShowWidget&name=OverdueActivities', '', 3, NULL, NULL, NULL),
(47, 4, 'DASHBOARDWIDGET', 'History', 'index.php?module=Contacts&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(48, 4, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Contacts&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(49, 4, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Contacts&view=ShowWidget&name=OverdueActivities', '', 3, NULL, NULL, NULL),
(50, 7, 'DASHBOARDWIDGET', 'History', 'index.php?module=Leads&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(51, 7, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Leads&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(52, 7, 'DASHBOARDWIDGET', 'Leads by Status', 'index.php?module=Leads&view=ShowWidget&name=LeadsByStatus', '', 4, NULL, NULL, NULL),
(53, 7, 'DASHBOARDWIDGET', 'Leads by Source', 'index.php?module=Leads&view=ShowWidget&name=LeadsBySource', '', 5, NULL, NULL, NULL),
(54, 7, 'DASHBOARDWIDGET', 'Leads by Industry', 'index.php?module=Leads&view=ShowWidget&name=LeadsByIndustry', '', 6, NULL, NULL, NULL),
(55, 7, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Leads&view=ShowWidget&name=OverdueActivities', '', 7, NULL, NULL, NULL),
(56, 13, 'DASHBOARDWIDGET', 'Tickets by Status', 'index.php?module=HelpDesk&view=ShowWidget&name=TicketsByStatus', '', 1, NULL, NULL, NULL),
(57, 13, 'DASHBOARDWIDGET', 'Open Tickets', 'index.php?module=HelpDesk&view=ShowWidget&name=OpenTickets', '', 2, NULL, NULL, NULL),
(58, 3, 'DASHBOARDWIDGET', 'History', 'index.php?module=Home&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(59, 3, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Home&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(60, 3, 'DASHBOARDWIDGET', 'Funnel', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesStage', '', 3, NULL, NULL, NULL),
(61, 3, 'DASHBOARDWIDGET', 'Potentials by Stage', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesPerson', '', 4, NULL, NULL, NULL),
(62, 3, 'DASHBOARDWIDGET', 'Pipelined Amount', 'index.php?module=Potentials&view=ShowWidget&name=PipelinedAmountPerSalesPerson', '', 5, NULL, NULL, NULL),
(63, 3, 'DASHBOARDWIDGET', 'Total Revenue', 'index.php?module=Potentials&view=ShowWidget&name=TotalRevenuePerSalesPerson', '', 6, NULL, NULL, NULL),
(64, 3, 'DASHBOARDWIDGET', 'Top Potentials', 'index.php?module=Potentials&view=ShowWidget&name=TopPotentials', '', 7, NULL, NULL, NULL),
(65, 3, 'DASHBOARDWIDGET', 'Leads by Status', 'index.php?module=Leads&view=ShowWidget&name=LeadsByStatus', '', 10, NULL, NULL, NULL),
(66, 3, 'DASHBOARDWIDGET', 'Leads by Source', 'index.php?module=Leads&view=ShowWidget&name=LeadsBySource', '', 11, NULL, NULL, NULL),
(67, 3, 'DASHBOARDWIDGET', 'Leads by Industry', 'index.php?module=Leads&view=ShowWidget&name=LeadsByIndustry', '', 12, NULL, NULL, NULL),
(68, 3, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Home&view=ShowWidget&name=OverdueActivities', '', 13, NULL, NULL, NULL),
(69, 3, 'DASHBOARDWIDGET', 'Tickets by Status', 'index.php?module=HelpDesk&view=ShowWidget&name=TicketsByStatus', '', 13, NULL, NULL, NULL),
(70, 3, 'DASHBOARDWIDGET', 'Open Tickets', 'index.php?module=HelpDesk&view=ShowWidget&name=OpenTickets', '', 14, NULL, NULL, NULL),
(71, 13, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(72, 15, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(73, 2, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(74, 4, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(75, 6, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(76, 7, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(77, 8, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(78, 9, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(79, 10, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(80, 13, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(81, 14, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(82, 15, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(83, 16, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(84, 18, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(85, 19, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(86, 20, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(87, 21, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(88, 22, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(89, 23, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(90, 26, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(91, 28, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(92, 34, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(93, 35, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(94, 37, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(95, 41, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(96, 42, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(97, 43, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
(98, 44, 'DETAILVIEWBASIC', 'View History', 'javascript:ModTrackerCommon.showhistory(''$RECORD$'')', '', 0, 'modules/ModTracker/ModTracker.php', 'ModTracker', 'isViewPermitted'),
...
(106, 6, 'DETAILVIEWSIDEBARWIDGET', 'Google Map', 'module=Google&view=Map&mode=showMap&viewtype=detail', '', 0, NULL, NULL, NULL);
...
(1, 'admin', '::1', '0000-00-00 00:00:00', '2018-01-30 10:21:45', 'Signed in'),
(2, 'admin', '::1', '0000-00-00 00:00:00', '2018-01-30 11:09:19', 'Signed in'),
(3, 'admin', '::1', '0000-00-00 00:00:00', '2018-01-30 12:06:29', 'Signed in'),
(4, 'admin', '::1', '0000-00-00 00:00:00', '2018-01-30 12:06:30', 'Signed in'),
(5, 'admin', '::1', '2018-01-30 12:34:42', '2018-01-30 12:34:09', 'Signed off'),
(6, 'admin', '::1', '2018-01-30 12:46:15', '2018-01-30 12:46:11', 'Signed off'),
(7, 'admin', '::1', '2018-01-30 12:57:01', '2018-01-30 12:54:00', 'Signed off'),
(8, 'admin', '::1', '2018-01-30 12:57:34', '2018-01-30 12:57:06', 'Signed off'),
(9, 'admin', '123.231.122.173', '2018-01-31 01:16:37', '2018-01-31 00:58:48', 'Signed off'),
(10, 'admin', '123.231.122.173', '0000-00-00 00:00:00', '2018-01-31 01:16:49', 'Signed in'),
(11, 'admin', '112.134.105.147', '0000-00-00 00:00:00', '2018-01-31 09:53:43', 'Signed in'),
(12, 'admin', '112.134.160.212', '0000-00-00 00:00:00', '2018-03-21 14:44:51', 'Signed in'),
(13, 'admin', '112.134.160.212', '2018-03-21 14:56:40', '2018-03-21 14:52:36', 'Signed off'),
(14, 'admin', '112.134.160.212', '0000-00-00 00:00:00', '2018-03-21 14:57:49', 'Signed in');
...
(1, 2, 'HelpDesk', 1, '2018-01-30 15:59:27', 2),
(2, 3, 'HelpDesk', 1, '2018-01-30 16:01:14', 2),
(3, 4, 'HelpDesk', 1, '2018-01-30 16:01:55', 2),
(4, 5, 'Contacts', 1, '2018-01-30 16:36:13', 2),
(5, 6, 'HelpDesk', 1, '2018-01-30 17:38:32', 2),
(6, 7, 'ModComments', 1, '2018-01-30 17:53:55', 2),
(7, 8, 'HelpDesk', 1, '2018-03-21 09:48:23', 2);
...
(1, 'ticketpriorities', NULL, 'Low'),
(1, 'ticketseverities', NULL, 'Nesaratnam Sivanoly'),
(1, 'ticketstatus', NULL, 'Open'),
(1, 'createdtime', NULL, '2018-01-30 15:59:27'),
(1, 'modifiedby', NULL, '1'),
(1, 'ticket_title', NULL, 'Tst 1'),
(1, 'record_id', NULL, '2'),
(1, 'record_module', NULL, 'HelpDesk'),
(2, 'ticket_no', NULL, 'TT2'),
(2, 'assigned_user_id', NULL, '1'),
(2, 'ticketpriorities', NULL, 'Low'),
(2, 'ticketseverities', NULL, 'Nesaratnam Sivanoly'),
(2, 'ticketstatus', NULL, 'Open'),
(2, 'createdtime', NULL, '2018-01-30 16:01:14'),
(2, 'modifiedby', NULL, '1'),
(2, 'ticket_title', NULL, 'Tst 1'),
(2, 'record_id', NULL, '3'),
(2, 'record_module', NULL, 'HelpDesk'),
(3, 'ticket_no', NULL, 'TT3'),
(3, 'assigned_user_id', NULL, '1'),
(3, 'ticketpriorities', NULL, 'Low'),
(3, 'ticketseverities', NULL, 'Nesaratnam Sivanoly'),
(3, 'ticketstatus', NULL, 'Open'),
(3, 'createdtime', NULL, '2018-01-30 16:01:55'),
(3, 'modifiedby', NULL, '1'),
(3, 'ticket_title', NULL, 'Tst 1'),
(3, 'record_id', NULL, '4'),
(3, 'record_module', NULL, 'HelpDesk'),
(4, 'salutationtype', NULL, 'Mr.'),
(4, 'firstname', NULL, 'Nesaratnam'),
(4, 'contact_no', NULL, 'CON1'),
(4, 'phone', NULL, '776341201'),
(4, 'lastname', NULL, 'Sivanoly'),
(4, 'mobile', NULL, '776341201'),
(4, 'homephone', NULL, '776341201'),
(4, 'otherphone', NULL, '776341201'),
(4, 'fax', NULL, '776341201'),
(4, 'email', NULL, 'sivanoly@eight25media.com'),
(4, 'assistantphone', NULL, '776341201'),
(4, 'assigned_user_id', NULL, '1'),
(4, 'createdtime', NULL, '2018-01-30 16:36:13'),
(4, 'modifiedby', NULL, '1'),
(4, 'portal', NULL, '1'),
(4, 'support_start_date', NULL, '2018-01-30'),
(4, 'support_end_date', NULL, '2019-01-30'),
(4, 'record_id', NULL, '5'),
(4, 'record_module', NULL, 'Contacts'),
(5, 'ticket_no', NULL, 'TT4'),
(5, 'assigned_user_id', NULL, '1'),
(5, 'ticketpriorities', NULL, 'Low'),
(5, 'ticketseverities', NULL, 'Minor'),
(5, 'ticketstatus', NULL, 'Open'),
(5, 'ticketcategories', NULL, 'Big Problem'),
(5, 'createdtime', NULL, '2018-01-30 17:38:32'),
(5, 'modifiedby', NULL, '1'),
(5, 'ticket_title', NULL, 'Test 1'),
(5, 'description', NULL, ' Example: INSERT INTO tbl_name (col_A,col_B,col_C) VALUES (1,2,3)'),
(5, 'contact_id', NULL, '5'),
(5, 'record_id', NULL, '6'),
(5, 'record_module', NULL, 'HelpDesk'),
(6, 'commentcontent', NULL, 'hhh'),
(6, 'assigned_user_id', NULL, '1'),
(6, 'createdtime', NULL, '2018-01-30 17:53:55'),
(6, 'related_to', NULL, '6'),
(6, 'creator', NULL, '1'),
(6, 'customer', NULL, '5'),
(6, 'record_id', NULL, '7'),
(6, 'record_module', NULL, 'ModComments'),
(7, 'ticket_no', NULL, 'TT5'),
(7, 'assigned_user_id', NULL, '1'),
(7, 'ticketpriorities', NULL, 'Low'),
(7, 'ticketseverities', NULL, 'Feature'),
(7, 'ticketstatus', NULL, 'Open'),
(7, 'ticketcategories', NULL, 'Small Problem'),
(7, 'createdtime', NULL, '2018-03-21 09:48:23'),
(7, 'modifiedby', NULL, '1'),
(7, 'ticket_title', NULL, 'test issue'),
(7, 'description', NULL, 'test issue'),
(7, 'contact_id', NULL, '5'),
(7, 'record_id', NULL, '8'),
...
(1, 'vtiger', '95, 12th Main Road, 3rd Block, Rajajinagar', 'Bangalore', 'Karnataka', 'India', '560010', '+91 9243602352', '+91 9243602352', 'www.vtiger.com', 'vtiger-crm-logo.png', NULL);
...
INSERT INTO `vtiger_portalinfo` (`id`, `user_name`, `user_password`, `type`, `last_login_time`, `login_time`, `logout_time`, `isactive`) VALUES
(5, 'sivanoly@eight25media.com', '6xjczfzn', 'C', '2018-03-21 09:45:42', '2018-03-21 09:45:42', '2018-03-21 09:50:08', 1);
...
(129, 35, 13, 'get_related_list', 1, 'HelpDesk', 0, 'ADD,SELECT'),
(130, 35, 20, 'get_quotes', 2, 'Quotes', 0, 'ADD'),
(131, 35, 21, 'get_purchase_orders', 3, 'Purchase Order', 0, 'ADD'),
(132, 35, 22, 'get_salesorder', 4, 'Sales Order', 0, 'ADD'),
(133, 35, 23, 'get_invoices', 5, 'Invoice', 0, 'ADD'),
(134, 35, 19, 'get_service_pricebooks', 6, 'PriceBooks', 0, 'ADD'),
(135, 35, 7, 'get_related_list', 7, 'Leads', 0, 'SELECT'),
(136, 35, 6, 'get_related_list', 8, 'Accounts', 0, 'SELECT'),
(137, 35, 4, 'get_related_list', 9, 'Contacts', 0, 'SELECT'),
(138, 35, 2, 'get_related_list', 10, 'Potentials', 0, 'SELECT'),
(139, 35, 8, 'get_attachments', 11, 'Documents', 0, 'ADD,SELECT'),
(140, 34, 13, 'get_related_list', 1, 'Service Requests', 0, 'ADD,SELECT'),
(141, 34, 8, 'get_attachments', 2, 'Documents', 0, 'ADD,SELECT'),
(142, 37, 13, 'get_related_list', 1, 'HelpDesk', 0, 'ADD,SELECT'),
(143, 37, 8, 'get_attachments', 2, 'Documents', 0, 'ADD,SELECT'),
(144, 43, 8, 'get_attachments', 1, 'Documents', 0, 'ADD,SELECT'),
(145, 44, 43, 'get_dependents_list', 1, 'Project Tasks', 0, 'ADD'),
(146, 44, 42, 'get_dependents_list', 2, 'Project Milestones', 0, 'ADD'),
(147, 44, 8, 'get_attachments', 3, 'Documents', 0, 'ADD,SELECT'),
(148, 44, 13, 'get_related_list', 4, 'HelpDesk', 0, 'ADD,SELECT'),
(149, 44, 0, 'get_gantt_chart', 5, 'Charts', 0, ''),
(150, 46, 6, 'get_related_list', 1, 'Accounts', 0, ' '),
(151, 46, 4, 'get_related_list', 2, 'Contacts', 0, ' '),
(152, 46, 7, 'get_related_list', 3, 'Leads', 0, ' '),
(153, 4, 37, 'get_dependents_list', 16, 'Assets', 0, 'ADD');
...
(8, 2, 'VTLIB_LBL_MODULE_MANAGER', 'vtlib_modmng.gif', 'VTLIB_LBL_MODULE_MANAGER_DESCRIPTION', 'index.php?module=ModuleManager&parent=Settings&view=List', 1, 0, 1),
(9, 2, 'LBL_PICKLIST_EDITOR', 'picklist.gif', 'LBL_PICKLIST_DESCRIPTION', 'index.php?parent=Settings&module=Picklist&view=Index', 2, 0, 1),
(10, 2, 'LBL_PICKLIST_DEPENDENCY_SETUP', 'picklistdependency.gif', 'LBL_PICKLIST_DEPENDENCY_DESCRIPTION', 'index.php?parent=Settings&module=PickListDependency&view=List', 3, 0, 0),
(11, 2, 'LBL_MENU_EDITOR', 'menueditor.png', 'LBL_MENU_DESC', 'index.php?module=MenuEditor&parent=Settings&view=Index', 4, 0, 0),
(12, 3, 'NOTIFICATIONSCHEDULERS', 'notification.gif', 'LBL_NOTIF_SCHED_DESCRIPTION', 'index.php?module=Settings&view=listnotificationschedulers&parenttab=Settings', 1, 0, 0),
(13, 3, 'INVENTORYNOTIFICATION', 'inventory.gif', 'LBL_INV_NOTIF_DESCRIPTION', 'index.php?module=Settings&view=listinventorynotifications&parenttab=Settings', 2, 0, 0),
(14, 3, 'LBL_COMPANY_DETAILS', 'company.gif', 'LBL_COMPANY_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=CompanyDetails', 3, 0, 0),
(15, 4, 'LBL_MAIL_SERVER_SETTINGS', 'ogmailserver.gif', 'LBL_MAIL_SERVER_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=OutgoingServerDetail', 1, 0, 0),
(16, 4, 'LBL_CURRENCY_SETTINGS', 'currency.gif', 'LBL_CURRENCY_DESCRIPTION', 'index.php?parent=Settings&module=Currency&view=List', 2, 0, 0),
(17, 4, 'LBL_TAX_SETTINGS', 'taxConfiguration.gif', 'LBL_TAX_DESCRIPTION', 'index.php?module=Vtiger&parent=Settings&view=TaxIndex', 3, 0, 0),
(18, 4, 'LBL_SYSTEM_INFO', 'system.gif', 'LBL_SYSTEM_DESCRIPTION', 'index.php?module=Settings&submodule=Server&view=ProxyConfig', 4, 1, 0),
(19, 4, 'LBL_ANNOUNCEMENT', 'announ.gif', 'LBL_ANNOUNCEMENT_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=AnnouncementEdit', 5, 0, 0),
(20, 4, 'LBL_DEFAULT_MODULE_VIEW', 'set-IcoTwoTabConfig.gif', 'LBL_DEFAULT_MODULE_VIEW_DESC', 'index.php?module=Settings&action=DefModuleView&parenttab=Settings', 6, 0, 0),
(21, 4, 'INVENTORYTERMSANDCONDITIONS', 'terms.gif', 'LBL_INV_TANDC_DESCRIPTION', 'index.php?parent=Settings&module=Vtiger&view=TermsAndConditionsEdit', 7, 0, 0),
(22, 4, 'LBL_CUSTOMIZE_MODENT_NUMBER', 'settingsInvNumber.gif', 'LBL_CUSTOMIZE_MODENT_NUMBER_DESCRIPTION', 'index.php?module=Vtiger&parent=Settings&view=CustomRecordNumbering', 8, 0, 0),
(23, 4, 'LBL_MAIL_SCANNER', 'mailScanner.gif', 'LBL_MAIL_SCANNER_DESCRIPTION', 'index.php?parent=Settings&module=MailConverter&view=List', 9, 0, 0),
(24, 4, 'LBL_LIST_WORKFLOWS', 'settingsWorkflow.png', 'LBL_LIST_WORKFLOWS_DESCRIPTION', 'index.php?module=Workflows&parent=Settings&view=List', 10, 0, 1),
(25, 4, 'LBL_CONFIG_EDITOR', 'migrate.gif', 'LBL_CONFIG_EDITOR_DESCRIPTION', 'index.php?module=Vtiger&parent=Settings&view=ConfigEditorDetail', 11, 0, 0),
(26, 4, 'Scheduler', 'Cron.png', 'Allows you to Configure Cron Task', 'index.php?module=CronTasks&parent=Settings&view=List', 12, 0, 0),
(27, 4, 'ModTracker', 'set-IcoLoginHistory.gif', 'LBL_MODTRACKER_DESCRIPTION', 'index.php?module=ModTracker&action=BasicSettings&parenttab=Settings&formodule=ModTracker', 13, 0, 0),
(28, 4, 'LBL_CUSTOMER_PORTAL', 'portal_icon.png', 'PORTAL_EXTENSION_DESCRIPTION', 'index.php?module=CustomerPortal&action=index&parenttab=Settings', 14, 0, 0),
(29, 4, 'Webforms', 'modules/Webforms/img/Webform.png', 'LBL_WEBFORMS_DESCRIPTION', 'index.php?module=Webforms&view=List&parent=Settings', 15, 1, 0),
...
INSERT INTO `vtiger_soapservice` (`id`, `type`, `sessionid`) VALUES
(5, 'customer', 'zhyx2w44');
...
(1, 'smtp.sendgrid.net', 0, 'eight25mediamail', '8N09zEGwGG', 'email', 'true', NULL, 'support@eight25media.com');
...
(1, 'Dashboard', 0, -1, 'Dashboards', NULL, NULL, 0, 1, 0, NULL, 'Analytics'),
(2, 'Potentials', 1, -1, 'Potentials', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(3, 'Home', 0, -1, 'Home', NULL, NULL, 0, 1, 0, NULL, NULL),
(4, 'Contacts', 0, 2, 'Contacts', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(6, 'Accounts', 1, -1, 'Accounts', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(7, 'Leads', 1, -1, 'Leads', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(8, 'Documents', 1, -1, 'Documents', NULL, NULL, 0, 0, 1, NULL, 'Tools'),
(9, 'Calendar', 1, -1, 'Calendar', NULL, NULL, 0, 0, 1, NULL, 'Tools'),
(10, 'Emails', 0, -1, 'Emails', NULL, NULL, 0, 1, 1, NULL, 'Tools'),
(13, 'HelpDesk', 0, 1, 'HelpDesk', NULL, NULL, 0, 0, 1, NULL, 'Support'),
(14, 'Products', 1, -1, 'Products', NULL, NULL, 0, 0, 1, NULL, 'Inventory'),
(15, 'Faq', 1, -1, 'Faq', NULL, NULL, 0, 1, 1, NULL, 'Support'),
(16, 'Events', 2, -1, 'Events', NULL, NULL, 0, 0, 1, NULL, NULL),
(18, 'Vendors', 1, -1, 'Vendors', NULL, NULL, 0, 0, 1, NULL, 'Inventory'),
(19, 'PriceBooks', 1, -1, 'PriceBooks', NULL, NULL, 0, 1, 1, NULL, 'Inventory'),
(20, 'Quotes', 1, -1, 'Quotes', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(21, 'PurchaseOrder', 1, -1, 'PurchaseOrder', NULL, NULL, 0, 0, 1, NULL, 'Inventory'),
(22, 'SalesOrder', 1, -1, 'SalesOrder', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(23, 'Invoice', 1, -1, 'Invoice', NULL, NULL, 0, 0, 1, NULL, 'Sales'),
(24, 'Rss', 1, -1, 'Rss', NULL, NULL, 0, 1, 0, NULL, 'Tools'),
(25, 'Reports', 0, -1, 'Reports', NULL, NULL, 0, 1, 0, NULL, 'Analytics'),
(26, 'Campaigns', 1, -1, 'Campaigns', NULL, NULL, 0, 0, 1, NULL, 'Marketing'),
...
(30, 'Import', 0, -1, 'Import', NULL, NULL, 1, 0, 0, '1.7', ''),
(31, 'MailManager', 0, -1, 'MailManager', NULL, NULL, 1, 0, 0, '1.9', 'Tools'),
(32, 'Mobile', 0, -1, 'Mobile', NULL, NULL, 1, 0, 0, '1.9', ''),
(33, 'ModTracker', 0, -1, 'ModTracker', NULL, NULL, 0, 0, 0, '1.2', ''),
(34, 'ServiceContracts', 1, -1, 'Service Contracts', NULL, NULL, 0, 0, 1, '2.4', 'Support'),
(35, 'Services', 1, -1, 'Services', NULL, NULL, 0, 0, 1, '2.6', 'Inventory'),
(36, 'WSAPP', 0, -1, 'WSAPP', NULL, NULL, 1, 0, 0, '3.4.4', ''),
(37, 'Assets', 1, -1, 'Assets', NULL, NULL, 0, 0, 1, '2.0', 'Inventory'),
(38, 'CustomerPortal', 0, -1, 'CustomerPortal', NULL, NULL, 0, 0, 0, '1.4', ''),
(39, 'EmailTemplates', 1, -1, 'Email Templates', NULL, NULL, 1, 0, 0, '1.0', 'Tools'),
(40, 'Google', 1, -1, 'Google', NULL, NULL, 0, 0, 0, '1.5', ''),
(41, 'ModComments', 1, -1, 'Comments', NULL, NULL, 0, 0, 1, '2.1', 'Tools'),
(42, 'ProjectMilestone', 1, -1, 'ProjectMilestone', NULL, NULL, 0, 0, 1, '3.0', 'Support'),
(43, 'ProjectTask', 1, -1, 'ProjectTask', NULL, NULL, 0, 0, 1, '3.1', 'Support'),
(44, 'Project', 1, -1, 'Project', NULL, NULL, 0, 0, 1, '3.3', 'Support'),
(45, 'RecycleBin', 1, -1, 'Recycle Bin', NULL, NULL, 0, 0, 0, '1.5', 'Tools'),
(46, 'SMSNotifier', 1, -1, 'SMSNotifier', NULL, NULL, 0, 0, 1, '1.9', 'Tools'),
(47, 'Webforms', 1, -1, 'Webforms', NULL, NULL, 0, 0, 0, '1.5', '');
...
(2, 'TT1', NULL, '0', '0', 'Low', 'Nesaratnam Sivanoly', 'Open', NULL, 'Tst 1', '', '', NULL, '0', '0', 0),
(3, 'TT2', NULL, '0', '0', 'Low', 'Nesaratnam Sivanoly', 'Open', NULL, 'Tst 1', '', '', NULL, '0', '0', 0),
(4, 'TT3', NULL, '0', '0', 'Low', 'Nesaratnam Sivanoly', 'Open', NULL, 'Tst 1', '', '', NULL, '0', '0', 0),
(6, 'TT4', NULL, '0', '0', 'Low', 'Minor', 'Open', 'Big Problem', 'Test 1', '', '', NULL, '0', '0', 5),
(8, 'TT5', NULL, '0', '0', 'Low', 'Feature', 'Open', 'Small Problem', 'test issue', '', '', NULL, '0', '0', 5);
...
(1, 'vtigerCRM', '5a7093801ab43', 'user');
...
INSERT INTO `vtiger_ws_userauthtoken` (`userid`, `token`, `expiretime`) VALUES
(1, '5a7096f29e960', 1517328414);
...
ALTER TABLE `vtiger_def_org_share`
  ADD PRIMARY KEY (`ruleid`), ADD KEY `fk_1_vtiger_def_org_share` (`permission`);
...
ALTER TABLE `vtiger_group2role`
  ADD PRIMARY KEY (`groupid`,`roleid`), ADD KEY `fk_2_vtiger_group2role` (`roleid`);

--
-- Indexes for table `vtiger_group2rs`
--
ALTER TABLE `vtiger_group2rs`
  ADD PRIMARY KEY (`groupid`,`roleandsubid`), ADD KEY `fk_2_vtiger_group2rs` (`roleandsubid`);
...
ALTER TABLE `vtiger_homestuff`
  ADD PRIMARY KEY (`stuffid`), ADD KEY `stuff_stuffid_idx` (`stuffid`), ADD KEY `fk_1_vtiger_homestuff` (`userid`);
...
ALTER TABLE `vtiger_invoice`
  ADD PRIMARY KEY (`invoiceid`), ADD KEY `invoice_purchaseorderid_idx` (`invoiceid`), ADD KEY `fk_2_vtiger_invoice` (`salesorderid`);
...
ALTER TABLE `vtiger_org_share_action2tab`
  ADD PRIMARY KEY (`share_action_id`,`tabid`), ADD KEY `fk_2_vtiger_org_share_action2tab` (`tabid`);
...
ALTER TABLE `vtiger_parenttabrel`
  ADD KEY `parenttabrel_tabid_parenttabid_idx` (`tabid`,`parenttabid`), ADD KEY `fk_2_vtiger_parenttabrel` (`parenttabid`);
...
ALTER TABLE `vtiger_recurringevents`
  ADD PRIMARY KEY (`recurringid`), ADD KEY `fk_1_vtiger_recurringevents` (`activityid`);
...
ALTER TABLE `vtiger_reportsortcol`
  ADD PRIMARY KEY (`sortcolid`,`reportid`), ADD KEY `fk_1_vtiger_reportsortcol` (`reportid`);
...
ALTER TABLE `vtiger_role2picklist`
  ADD PRIMARY KEY (`roleid`,`picklistvalueid`,`picklistid`), ADD KEY `role2picklist_roleid_picklistid_idx` (`roleid`,`picklistid`,`picklistvalueid`), ADD KEY `fk_2_vtiger_role2picklist` (`picklistid`);
...
ALTER TABLE `vtiger_settings_field`
  ADD PRIMARY KEY (`fieldid`), ADD KEY `fk_1_vtiger_settings_field` (`blockid`);
...
ALTER TABLE `vtiger_users2group`
  ADD PRIMARY KEY (`groupid`,`userid`), ADD KEY `users2group_groupname_uerid_idx` (`groupid`,`userid`), ADD KEY `fk_2_vtiger_users2group` (`userid`);
...
ALTER TABLE `vtiger_user_module_preferences`
  ADD PRIMARY KEY (`userid`,`tabid`), ADD KEY `fk_2_vtiger_user_module_preferences` (`tabid`);
...
--
ALTER TABLE `vtiger_activitytype`
  MODIFY `activitytypeid` int(19) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `vtiger_currencies`
  MODIFY `currencyid` int(19) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=133;
--
...
--
ALTER TABLE `vtiger_def_org_share`
  MODIFY `ruleid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `vtiger_eventhandlers`
  MODIFY `eventhandler_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `vtiger_eventhandler_module`
--
ALTER TABLE `vtiger_eventhandler_module`
  MODIFY `eventhandler_module_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `vtiger_field`
  MODIFY `fieldid` int(19) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=703;
--
...
--
ALTER TABLE `vtiger_smsnotifier_status`
  MODIFY `statusid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
