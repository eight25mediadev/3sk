<?php /* Smarty version Smarty-3.1.7, created on 2018-03-21 09:55:06
         compiled from "/home/eight25test/3sk.825mediatesting.com/includes/runtime/../../layouts/vlayout/modules/Settings/Profiles/EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18431571745ab22bfa9d7a38-06029976%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da557a4c5f72855c06fa1b3d62a74e52dd92f433' => 
    array (
      0 => '/home/eight25test/3sk.825mediatesting.com/includes/runtime/../../layouts/vlayout/modules/Settings/Profiles/EditView.tpl',
      1 => 1383547495,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18431571745ab22bfa9d7a38-06029976',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ab22bfadf392',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ab22bfadf392')) {function content_5ab22bfadf392($_smarty_tpl) {?>
<div class="container-fluid"><h3><?php echo vtranslate('LBL_CREATE_PROFILE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</h3><hr><form id="EditView" name="EditProfile" action="index.php" method="post" class="form-horizontal"><input type="hidden" name="module" value="Profiles" /><input type="hidden" name="action" value="Save" /><input type="hidden" name="parent" value="Settings" /><?php $_smarty_tpl->tpl_vars['RECORD_ID'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getId(), null, 0);?><input type="hidden" name="record" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
" /><input type="hidden" name="mode" value="<?php echo $_smarty_tpl->tpl_vars['MODE']->value;?>
" /><div class="row-fluid"><div class="row-fluid"><label class="fieldLabel span2"><span class="redColor">*</span><strong><?php echo vtranslate('LBL_PROFILE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" data-validation-engine="validate[required]"  /></div><br><div class="row-fluid"><label class="fieldLabel span2"><strong><?php echo vtranslate('LBL_DESCRIPTION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</span></span></label></div><div class="row-fluid"><label class="fieldLabel"><strong><?php echo vtranslate('LBL_EDIT_PRIVILIGES_FOR_THIS_PROFILE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
:</strong></label><br><table class="table table-striped table-bordered profilesEditView"><thead><tr class="blockHeader"><th width="30%" style="border-left: 1px solid #DDD !important;"><input checked="true" class="alignTop" type="checkbox" id="mainModulesCheckBox" />&nbsp;<?php echo vtranslate('LBL_MODULES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
-unchecked="true"<?php }?>><?php }?></td><?php } ?><td style="border-left: 1px solid #DDD !important;"><?php if ($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->getFields()){?><div class="row-fluid"><span class="span4">&nbsp;</span><span class="span4"><button type="button" data-handlerfor="fields" data-togglehandler="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
...
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table></div></td></tr><?php }?><?php } ?></tbody></table></div></div><div class="pull-right"><button class="btn btn-success" type="submit"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
